...
from shared.result import Err, Ok, Result, UnwrapError, err, ok

from interface.api.errors.exceptions import (
    BuilderValidationError,
)
from interface.api.errors.messages import ErrorCode, ErrorMessage
...
from interface.api.patterns.builder import BuilderValidationError, FluentBuilder
...
class TestTransformerProperties:
    ...
    def test_composite_transformer_chain_composition(self, value: int) -> None:
        ...
        **Validates: Requirements 1.3**
        ...
        # Apply sequentially
        sequential_result = double.transform(add_one.transform(value, context), context)
