...
class TestRepositoryUpdatePersistence:
    ...
    @pytest.mark.asyncio
    async def test_update_persistence(self, create_data: SampleCreateDTO, new_name: str, new_value: float) -> None:
        """
...
class TestRepositoryPagination:
    ...
    @pytest.mark.asyncio
    async def test_pagination_bounds(self, items: list[SampleCreateDTO], skip: int, limit: int) -> None:
        """
