...
pytest.skip("Dapr invoke module not implemented", allow_module_level=True)

from unittest.mock import AsyncMock, MagicMock, patch

from hypothesis import given, settings, strategies as st

from infrastructure.dapr.invoke import HttpMethod, ServiceInvoker
