...
REFACTORED_PACKAGES_PHASE2: list[str] = [
    ...
    "src/my_api/shared/waf",
    "src/my_api/shared/hot_reload",
    "src/my_api/shared/auto_ban",
    "src/my_api/shared/csp_generator",
    "src/my_api/shared/lazy",
    "src/my_api/shared/fingerprint",
...
REFACTORED_MODULES_PHASE2: list[str] = [
    "my_api.shared.waf",
    "my_api.shared.hot_reload",
    "my_api.shared.auto_ban",
    "my_api.shared.csp_generator",
    "my_api.shared.lazy",
    "my_api.shared.fingerprint",
    "my_api.shared.query_analyzer",
    "my_api.shared.protocols",
    "my_api.shared.multitenancy",
    "my_api.shared.background_tasks",
    "my_api.shared.http2_config",
    "my_api.shared.connection_pool",
    "my_api.shared.memory_profiler",
    "my_api.shared.bff",
    "my_api.shared.request_signing",
    "my_api.shared.feature_flags",
    "my_api.shared.streaming",
    "my_api.shared.api_composition",
    "my_api.shared.response_transformation",
    "my_api.shared.mutation_testing",
    "my_api.shared.graphql_federation",
    "my_api.infrastructure.auth.token_store",
    "my_api.infrastructure.observability.telemetry",
    "my_api.adapters.api.websocket.types",
