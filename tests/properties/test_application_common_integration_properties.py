...
class TestErrorHierarchyProperties:
    ...
    **Validates: Requirements 1.1**
    ...
    def test_not_found_error_is_application_error(
...
class TestNotFoundErrorProperties:
    ...
    **Validates: Requirements 1.2**
    ...
    def test_not_found_error_contains_entity_info(
...
class TestValidationErrorProperties:
    ...
    **Validates: Requirements 1.3**
    ...
    def test_validation_error_contains_field_info(
        self, message: str, field: str
    ) -> None:
...
class TestCommandDispatchProperties:
    ...
    **Validates: Requirements 2.1, 2.2, 2.3**
    ...
    def test_create_item_command_is_immutable(
        self, name: str, sku: str, price: Decimal
    ) -> None:
...
class TestMapperRoundTripProperties:
    ...
    **Validates: Requirements 4.1, 4.2**
    ...
    def test_item_mapper_preserves_essential_fields(
...
class TestValidationMiddlewareProperties:
    ...
    **Validates: Requirements 5.4**
    ...
    def test_create_item_validator_rejects_empty_name(
        self, empty_name: str, valid_sku: str
    ) -> None:
        ...
        command = CreateItemCommand(
            name=empty_name, sku=valid_sku, price_amount=Decimal("10.00")
        )
...
class TestExportImportRoundTripProperties:
    ...
    **Validates: Requirements 7.1, 7.2, 7.3, 7.4**
    ...
    def test_json_export_contains_metadata(self, name: str, sku: str) -> None:
        ...
        from application.examples.item.export import ExportFormat, ExportMetadata
