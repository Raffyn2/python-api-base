...
from core.base.entity import AuditableEntity, BaseEntity, ULIDEntity, VersionedEntity
...
class CreateItemHandler(CommandHandler[CreateItemCommand, TestItemEntity]):
    ...
    def __init__(
        self,
        repo: InMemoryRepository[TestItemEntity, TestItemCreate, TestItemUpdate, str],
    ) -> None:
        self._repo = repo
