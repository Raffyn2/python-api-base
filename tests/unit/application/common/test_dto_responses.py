...
class TestApiResponse:
    ...
    def test_create_api_response(self) -> None:
        ...
        response = ApiResponse(data={"id": "123", "name": "Test"}, message="Success", status_code=200)
    ...
    def test_api_response_with_request_id(self) -> None:
        ...
        response = ApiResponse(data="test", request_id="req-123-456")
...
class TestPaginatedResponse:
    ...
    def test_create_paginated_response(self) -> None:
        ...
        response = PaginatedResponse(items=[{"id": "1"}, {"id": "2"}], total=100, page=1, size=10)
    ...
    def test_paginated_response_generic_type(self) -> None:
        ...
        # Dict items
        dict_response = PaginatedResponse(items=[{"id": "1"}, {"id": "2"}], total=2, page=1, size=10)
        assert len(dict_response.items) == 2

        # String items
        str_response = PaginatedResponse(items=["a", "b", "c"], total=3, page=1, size=10)
    ...
    def test_paginated_response_serialization(self) -> None:
        ...
        response = PaginatedResponse(items=[{"id": "1"}], total=50, page=2, size=10)
    ...
    def test_edge_case_single_item(self) -> None:
        ...
        response = PaginatedResponse(items=[{"id": "1"}], total=1, page=1, size=10)
