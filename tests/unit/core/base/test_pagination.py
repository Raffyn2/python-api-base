...
class TestCursorPage:
    ...
    def test_create_cursor_page(self) -> None:
        ...
        page = CursorPage(items=items, next_cursor="next123", prev_cursor="prev123", has_more=True)
    ...
    def test_cursor_page_no_more(self) -> None:
        ...
        page = CursorPage(items=[], next_cursor=None, prev_cursor="prev123", has_more=False)
...
class TestCursorPagination:
    ...
    def test_init_with_defaults(self) -> None:
        ...
        pagination = CursorPagination[TestEntity, dict](cursor_fields=["created_at", "id"])
    ...
    def test_init_with_custom_limit(self) -> None:
        ...
        pagination = CursorPagination[TestEntity, dict](cursor_fields=["id"], default_limit=50)
    ...
    def test_encode_cursor_single_field(self) -> None:
        ...
        pagination = CursorPagination[TestEntity, dict](cursor_fields=["id"])
    ...
    def test_encode_cursor_missing_field(self) -> None:
        ...
        pagination = CursorPagination[TestEntity, dict](cursor_fields=["id", "nonexistent"])
    ...
    def test_encode_cursor_none_value(self) -> None:
        ...
        pagination = CursorPagination[EntityWithNone, dict](cursor_fields=["id", "optional_field"])
