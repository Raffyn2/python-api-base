...
from my_app.domain.entities.{name} import {pascal_name}, {pascal_name}Response
from my_app.application.common.mapper import BaseMapper
...
def _generate_use_case_content(name: str, with_cache: bool = False) -> str:
    ...
    cache_import = "\nfrom my_app.shared.caching import cached" if with_cache else ""

    return f'''"""{pascal_name} use case implementation."""

from my_app.domain.entities.{name} import (
    {pascal_name},
    {pascal_name}Create,
...
from my_app.shared.use_case import BaseUseCase{cache_import}
...
from my_app.application.mappers.{name}_mapper import {pascal_name}Mapper
from my_app.application.use_cases.{name}_use_case import {pascal_name}UseCase
from my_app.domain.entities.{name} import (
    {pascal_name}Create,
    {pascal_name}Response,
    {pascal_name}Update,
...
# from my_app.core.container import Container
# from my_app.infrastructure.repositories.{name}_repository import {pascal_name}Repository
...
def get_{name}_use_case(
    ...
    from my_app.domain.entities.{name} import {pascal_name}
