...
These DTOs are optimized for query operations and may contain
denormalized data for efficient querying. They are populated
by event projections and stored in query-optimized views.

For write/command operations, use application.users.dto instead.
